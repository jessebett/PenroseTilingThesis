...
\section{Rhombus Representation of the Penrose Tiling} %DONE
...
\section{Substitution Construction} %DONE
...
\section{Up-Down Construction} %DONE
...
\end{subfigure}
\caption{By drawing these red edges, we can mutually locally derive Kites and Darts tilings from Rhombs tilings.}
